...
namespace Spaceports
{
    ...
    public static class SpaceportsHarmony
    {
        ...
        public static void TryModPatches()
        {
            ...
            if (Verse.ModLister.HasActiveModWithName("Hospitality (Continued)") || Verse.ModLister.HasActiveModWithName("Hospitality")) //conditional patch to Hospitality
            {
            ...
            //if (Verse.ModLister.HasActiveModWithName("Trader ships") || Verse.ModLister.HasActiveModWithName("Rim-Effect: Themis Traders"))
                if (Verse.ModLister.HasActiveModWithName("Trader ships") || Verse.ModLister.HasActiveModWithName("Trader Ships (Fork)"))
                {
                ...
                Log.Message("[Spaceports] Trader Ships FOUND, attempting to patch...");
        ...
        public static class Harmony_DropCellFinder_GetBestShuttleLandingSpot
        {
            static void Postfix(Map map, Faction factionForFindingSpot, ref IntVec3 __result)
            {
                ...
                else
                {
                    ...
                    __result = Utils.FindValidSpaceportPad(map, factionForFindingSpot, 2);
                }
                return;
            }
        }
