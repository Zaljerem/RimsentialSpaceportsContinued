...
namespace Spaceports
{
    ...
    public static class SpaceportsMisc //Misc complex constants 
    {
        ...
        static SpaceportsMisc()
        {
            ...
            {
                Log.Message("[Spaceports] Messing around with reflection and DBH...");
    ...
    public static class SpaceportsShuttleVariants //Compiles list of available shuttle variants at runtime.
    {
        ...
        static SpaceportsShuttleVariants()
        {
            ...
            {
                AllShuttleVariants.Add(TransportShipDefOf.Spaceports_RoyaltyShuttle);
            }
            if(Verse.ModLister.HasActiveModWithName("Vanilla Furniture Expanded - Props and Decor"))
            {
                AllShuttleVariants.Add(TransportShipDefOf.Spaceports_ShuttleSkip);
            }
            AllShuttleVariants.Add(TransportShipDefOf.Spaceports_ShuttleA);
            AllShuttleVariants.Add(TransportShipDefOf.Spaceports_ShuttleB);
            AllShuttleVariants.Add(TransportShipDefOf.Spaceports_ShuttleC);
            AllShuttleVariants.Add(TransportShipDefOf.Spaceports_ShuttleD);
            AllShuttleVariants.Add(TransportShipDefOf.Spaceports_ShuttleE);
            AllShuttleVariants.Add(TransportShipDefOf.Spaceports_ShuttleF);
            AllShuttleVariants.Add(TransportShipDefOf.Spaceports_ShuttleG);
            AllShuttleVariants.Add(TransportShipDefOf.Spaceports_ShuttleH);
            AllShuttleVariants.Add(TransportShipDefOf.Spaceports_ShuttleI);
            AllShuttleVariants.Add(TransportShipDefOf.Spaceports_ShuttleJ);
            AllShuttleVariants.Add(TransportShipDefOf.Spaceports_ShuttleK);
        }
    }
}