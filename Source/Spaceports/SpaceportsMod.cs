...
namespace Spaceports
{
    public class SpaceportsSettings : ModSettings
    {
        ...
        public override void ExposeData()
        {
            ...
            //Scribe_Values.Look(ref ignoreNoPad, "ignoreNoPad", false);
    ...
    public class SpaceportsMod : Mod
    {
        ...
        public override void DoSettingsWindowContents(Rect inRect)
        {
            ...
            if (settings.page == 1)
            {
                ...
                //listingStandard.CheckboxLabeled("Spaceports_IgnoreNoPad".Translate(), ref settings.ignoreNoPad);
            ...
            else if (settings.page == 3)
            {
                ...
                if (Verse.ModLister.HasActiveModWithName("Hospitality (Continued)"))
                {
